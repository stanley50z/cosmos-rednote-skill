...
### Other agent harnesses (`~/.agents/skills/`)

**Mac / Linux:**
```bash
git clone https://github.com/stanley50z/cosmos-rednote-skill.git ~/.agents/skills/cosmos-rednote-skill
```

**Windows (PowerShell):**
```powershell
git clone https://github.com/stanley50z/cosmos-rednote-skill.git "$env:USERPROFILE\.agents\skills\cosmos-rednote-skill"
```

### Both at once (Mac / Linux)

```bash
git clone https://github.com/stanley50z/cosmos-rednote-skill.git ~/.claude/skills/cosmos-rednote-skill
ln -s ~/.claude/skills/cosmos-rednote-skill ~/.agents/skills/cosmos-rednote-skill
```

### Paste into any agent with shell access

```text
Help me install cosmos-rednote-skill. Please:
1. git clone https://github.com/stanley50z/cosmos-rednote-skill.git ~/.claude/skills/cosmos-rednote-skill
2. ln -s ~/.claude/skills/cosmos-rednote-skill ~/.agents/skills/cosmos-rednote-skill
3. Verify both paths resolve to SKILL.md and references/, then tell me done.
```
